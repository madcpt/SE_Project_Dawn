package com.example.DAWN.UserManament;
...
import com.example.DAWN.UserManament.UserData;
...
//    public static final String VIBRATE = "vibrate";
    ...
    private static final String DB_CREATE = "CREATE TABLE " + TABLE_NAME + " ("
            + ID + " integer primary key," + USER_NAME + " char(50),"
            + USER_PWD + " char(50)" + ");";
    ...
    public int findUserByName(String userName)
    {
       ...
       // try {
            ...
            Log.i(TAG, "findUserByName  T1, userName=" + userName);
            if (mCursor != null) {
                result = mCursor.getCount();
                mCursor.close();
                Log.i(TAG, "findUserByName , result=0");
           // }
            return result;
        }
       // catch(Exception e)
